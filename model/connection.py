...
class Auth_connection():
    @staticmethod
    def check_if_member_exist(email,identity):
        n = 0
        cnx = None
    ...
    @staticmethod 
    def insert_new_member(name,email,hash_password,identity,date):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def confirm_member_information(email,identity):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def retrieve_member_information(id,identity):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod 
    def update_member_info(input,id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def change_initial_state(email):
        n = 0
        cnx = None
        msg = None
        while n < 500: 
...
class Food_connection():
    @staticmethod
    def insert_new_food(request_data,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def get_my_food_info(page,user_id):
        n = 0
        cnx = None
    ...
    @staticmethod            
    def get_public_food_info(keyword,page):
        n = 0
        cnx = None
...
class Plan_connection():
    ...
    @staticmethod
    def insert_new_diet_plan(request_data,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def update_diet_info(input,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def delete_diet(plan_id,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def get_diet_info(page,user_id):
        n = 0
        cnx = None
...
class Record_connection():
    ...
    @staticmethod
    def insert_new_record(request_data,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def update_record(input,user_id): 
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def get_record_info(datetimestamp,user_id):
        n = 0
        cnx = None
...
class Diet_connection():
    ...
    @staticmethod
    def insert_new_diet(request_data,user_id):
        n = 0
        cnx = None 
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def delete_diet(intake_id,user_id,record_id): 
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def get_diet_info(datetimestamp,user_id):
        n = 0
        cnx = None
        msg,record = None,None
        while n < 500: 
...
class Weight_connection():
    ...
    @staticmethod
    def insert_new_weight(input,user_id):
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def update_weight(input,user_id): 
        n = 0
        cnx = None
        result, msg = None, None
        while n < 500: 
    ...
    @staticmethod
    def get_weight_info(start_date,end_date,user_id):
        n = 0
        cnx = None
        msg,record = None,None
        while n < 500: 
...
class Notify_connection():
    ...
    @staticmethod
    def check_if_subscribe(identity,subcsription,id_):
        n = 0
        cnx = None
    ...
    @staticmethod
    def get_subscription_info(id_,identity):
        n = 0
        cnx = None
        msg,result = None, None
        while n < 500: 
